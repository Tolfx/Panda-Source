...
export class UnderCover {
  ...
  private async underCover(client, message, args) {
    ...
    message.channel.send("On it!").then(async (msg) => {
      const url =
        "https://steamcommunity.com/login/home/?goto=%2Fid%2Fme%2Fedit";
        ...
        if (previousSession) {
          ...
          if (cookiesArr.length !== 0) {
            ...
            if (DoneResult === "true") {
              ...
              if (
                page.url() !== "https://steamcommunity.com/id/Tolfx/edit/info"
              ) {
  ...
  private async goUndercover(page) {
    ...
    await fileChooser.accept([
      config.underCoverProfile + randomProfilePic + ".png",
    ]);
    await page.waitFor(2000);
