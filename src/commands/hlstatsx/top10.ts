...
export class topTen {
  ...
  private async getTopTen(client, message, args) {
    ...
    try {
      ...
      this.whichServer(args[0].toUpperCase(), args[1].toUpperCase()).then(
        async (serverURL) => {
          if (serverURL === "ERROR")
            return message.channel.send(`Error: ${serverURL}`);
  ...
  private async topTenNames(page: any): Promise<string[]> {
    let [nameOfTopOne] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[2]/td[2]`
    );
    ...
    let textContentNameOfTopThree = await nameOfTopThree.getProperty(
      "textContent"
    );
    ...
    let textContentNameOfTopFour = await nameOfTopFour.getProperty(
      "textContent"
    );
    ...
    let textContentNameOfTopFive = await nameOfTopFive.getProperty(
      "textContent"
    );
    ...
    let textContentNameOfTopSeven = await nameOfTopSeven.getProperty(
      "textContent"
    );
    ...
    let textContentNameOfTopEight = await nameOfTopEight.getProperty(
      "textContent"
    );
    ...
    let textContentNameOfTopNine = await nameOfTopNine.getProperty(
      "textContent"
    );
  ...
  private async topTenLinks(page: any): Promise<string[]> {
    let [nameOfTopOne] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[2]/td[2]/a`
    );
    let textContentNameOfTopOne = await nameOfTopOne.getProperty("href");
    let rawTextNameOfTopOne = await textContentNameOfTopOne.jsonValue();

    let [nameOfTopTwo] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[3]/td[2]/a`
    );
    ...
    let [nameOfTopSix] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[7]/td[2]/a`
    );
  ...
  private async topTenConnection(page: any): Promise<string[]> {
    let [nameOfTopOne] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[2]/td[6]`
    );
    let textContentNameOfTopOne = await nameOfTopOne.getProperty("textContent");
    let rawTextNameOfTopOne = await textContentNameOfTopOne.jsonValue();

    let [nameOfTopTwo] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[3]/td[6]`
    );
    let textContentNameOfTopTwo = await nameOfTopTwo.getProperty("textContent");
    let rawTextNameOfTopTwo = await textContentNameOfTopTwo.jsonValue();

    let [nameOfTopThree] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[4]/td[6]`
    );
    let textContentNameOfTopThree = await nameOfTopThree.getProperty(
      "textContent"
    );
    ...
    let [nameOfTopFour] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[5]/td[6]`
    );
    let textContentNameOfTopFour = await nameOfTopFour.getProperty(
      "textContent"
    );
    ...
    let [nameOfTopFive] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[6]/td[6]`
    );
    let textContentNameOfTopFive = await nameOfTopFive.getProperty(
      "textContent"
    );
    ...
    let [nameOfTopSix] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[7]/td[6]`
    );
    let textContentNameOfTopSix = await nameOfTopSix.getProperty("textContent");
    let rawTextNameOfTopSix = await textContentNameOfTopSix.jsonValue();

    let [nameOfTopSeven] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[8]/td[6]`
    );
    let textContentNameOfTopSeven = await nameOfTopSeven.getProperty(
      "textContent"
    );
    ...
    let [nameOfTopEight] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[9]/td[6]`
    );
    let textContentNameOfTopEight = await nameOfTopEight.getProperty(
      "textContent"
    );
    ...
    let [nameOfTopNine] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[10]/td[6]`
    );
    let textContentNameOfTopNine = await nameOfTopNine.getProperty(
      "textContent"
    );
    ...
    let [nameOfTopTen] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[11]/td[6]`
    );
    let textContentNameOfTopTen = await nameOfTopTen.getProperty("textContent");
    let rawTextNameOfTopTen = await textContentNameOfTopTen.jsonValue();
  ...
  private async topTenPoints(page: any): Promise<string[]> {
    let [nameOfTopOne] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[2]/td[4]`
    );
    let textContentNameOfTopOne = await nameOfTopOne.getProperty("textContent");
    let rawTextNameOfTopOne = await textContentNameOfTopOne.jsonValue();

    let [nameOfTopTwo] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[3]/td[4]`
    );
    let textContentNameOfTopTwo = await nameOfTopTwo.getProperty("textContent");
    let rawTextNameOfTopTwo = await textContentNameOfTopTwo.jsonValue();

    let [nameOfTopThree] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[4]/td[4]`
    );
    let textContentNameOfTopThree = await nameOfTopThree.getProperty(
      "textContent"
    );
    ...
    let [nameOfTopFour] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[5]/td[4]`
    );
    let textContentNameOfTopFour = await nameOfTopFour.getProperty(
      "textContent"
    );
    ...
    let [nameOfTopFive] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[6]/td[4]`
    );
    let textContentNameOfTopFive = await nameOfTopFive.getProperty(
      "textContent"
    );
    ...
    let [nameOfTopSix] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[7]/td[4]`
    );
    let textContentNameOfTopSix = await nameOfTopSix.getProperty("textContent");
    let rawTextNameOfTopSix = await textContentNameOfTopSix.jsonValue();

    let [nameOfTopSeven] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[8]/td[4]`
    );
    let textContentNameOfTopSeven = await nameOfTopSeven.getProperty(
      "textContent"
    );
    ...
    let [nameOfTopEight] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[9]/td[4]`
    );
    let textContentNameOfTopEight = await nameOfTopEight.getProperty(
      "textContent"
    );
    ...
    let [nameOfTopNine] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[10]/td[4]`
    );
    let textContentNameOfTopNine = await nameOfTopNine.getProperty(
      "textContent"
    );
    ...
    let [nameOfTopTen] = await page.$x(
      `/html/body/div[2]/div[1]/div[2]/table/tbody/tr[11]/td[4]`
    );
    let textContentNameOfTopTen = await nameOfTopTen.getProperty("textContent");
    let rawTextNameOfTopTen = await textContentNameOfTopTen.jsonValue();
        ...
        msg.react("⬅").then(async (r) => {
          ...
          backwards.on("collect", async (r, u) => {
            ...
            errorEmbed.setFooter(
              `Page ${pages} of ${names.length} | ${names[pages - 1]}`
            );
            msg.edit(errorEmbed);
          });
    ...
    if (argsOne.includes("EU")) {
      for (var xServer = 0; xServer < argsForServers; ++xServer) {
        if (argsTwo.includes(EUServer.Dodgeball_1[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf52`
            );
          });
        } else if (argsTwo.includes(EUServer.Duel[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf51`
            );
          });
        } else if (argsTwo.includes(EUServer.War3Source[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf49`
            );
          });
        } else if (argsTwo.includes(EUServer.Jump[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf50`
            );
          });
        } else if (argsTwo.includes(EUServer.Saxton_Hale[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf53`
            );
          });
        } else if (argsTwo.includes(EUServer.Hightower_1[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf47`
            );
          });
        } else if (argsTwo.includes(EUServer.MGE_1[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf42`
            );
          });
        } else if (argsTwo.includes(EUServer.Class_Warfare[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf29`
            );
          });
        } else if (argsTwo.includes(EUServer.Deahtrun[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf54`
            );
          });
        } else if (argsTwo.includes(EUServer.Hightower_2[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf48`
            );
          });
        } else if (argsTwo.includes(EUServer.Surf[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf33`
            );
          });
        } else if (argsTwo.includes(EUServer.Slender_Fortress[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf41`
            );
          });
        } else if (argsTwo.includes(EUServer.Freak_Fortress_2[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf55`
            );
          });
        } else if (argsTwo.includes(EUServer.Turbine[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf61`
            );
          });
        } else if (argsTwo.includes(EUServer.TwoFort[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf56`
            );
          });
        } else if (argsTwo.includes(EUServer.Jailbreak[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf43`
            );
          });
        } else if (argsTwo.includes(EUServer.Mario_Kart[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf46`
            );
          });
        } else if (argsTwo.includes(EUServer.Dodgeball_2[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf57`
            );
          });
        } else if (argsTwo.includes(EUServer.The_Hidden[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf38`
            );
          });
        } else if (argsTwo.includes(EUServer.Prophunt[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf36`
            );
          });
        } else if (argsTwo.includes(EUServer.Deathrun_2[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf37`
            );
          });
        } else if (argsTwo.includes(EUServer.MGE_2[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf39`
            );
          });
        } else if (argsTwo.includes(EUServer.Randomizer[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf30`
            );
          });
        } else if (argsTwo.includes(EUServer.Trade[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf58`
            );
          });
        } else if (argsTwo.includes(EUServer.Dustbowl[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf31`
            );
          });
        } else if (argsTwo.includes(EUServer.Orange_x3[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf35`
            );
          });
        } else if (argsTwo.includes(EUServer.Smash_Bros[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf32`
            );
          });
        } else if (argsTwo.includes(EUServer.Dodgeball_3[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf1`
            );
          });
        } else if (argsTwo.includes(EUServer.Hightower_3[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf2`
            );
          });
        } else if (argsTwo.includes(EUServer.Zombie_Fortress[xServer])) {
          return new Promise((resolve) => {
            resolve(
              `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf62`
            );
          });
        }
      }
      ...
      if (argsTwo.includes(SGServer.TwoFort)) {
        return new Promise((resolve) => {
          resolve(
            `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf22`
          );
        });
      } else if (argsTwo.includes(SGServer.Deathrun)) {
        return new Promise((resolve) => {
          resolve(
            `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf20`
          );
        });
      } else if (argsTwo.includes(SGServer.Dodgeball)) {
        return new Promise((resolve) => {
          resolve(
            `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf14`
          );
        });
      } else if (argsTwo.includes(SGServer.MGE)) {
        return new Promise((resolve) => {
          resolve(
            `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf23`
          );
        });
      } else if (argsTwo.includes(SGServer.Trade)) {
        return new Promise((resolve) => {
          resolve(
            `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf60`
          );
        });
      }
      ...
      if (argsTwo.includes(USServer.Deathrun)) {
        return new Promise((resolve) => {
          resolve(
            `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf28`
          );
        });
      } else if (argsTwo.includes(USServer.Dodgeball)) {
        return new Promise((resolve) => {
          resolve(
            `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf45`
          );
        });
      } else if (argsTwo.includes(USServer.Dustbowl)) {
        return new Promise((resolve) => {
          resolve(
            `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf65`
          );
        });
      } else if (argsTwo.includes(USServer.Freak_Fortress_2)) {
        return new Promise((resolve) => {
          resolve(
            `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf44`
          );
        });
      } else if (argsTwo.includes(USServer.Hightower)) {
        return new Promise((resolve) => {
          resolve(
            `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf63`
          );
        });
      } else if (argsTwo.includes(USServer.Jailbreak)) {
        return new Promise((resolve) => {
          resolve(
            `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf40`
          );
        });
      } else if (argsTwo.includes(USServer.Jump)) {
        return new Promise((resolve) => {
          resolve(
            `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf12`
          );
        });
      } else if (argsTwo.includes(USServer.MGE)) {
        return new Promise((resolve) => {
          resolve(
            `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf11`
          );
        });
      } else if (argsTwo.includes(USServer.Prophunt)) {
        return new Promise((resolve) => {
          resolve(
            `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf24`
          );
        });
      } else if (argsTwo.includes(USServer.Slender_Fortress)) {
        return new Promise((resolve) => {
          resolve(
            `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf25`
          );
        });
      } else if (argsTwo.includes(USServer.Trade)) {
        return new Promise((resolve) => {
          resolve(
            `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf3`
          );
        });
      } else if (argsTwo.includes(USServer.Turbine)) {
        return new Promise((resolve) => {
          resolve(
            `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf7`
          );
        });
      } else if (argsTwo.includes(USServer.Saxton_Hale)) {
        return new Promise((resolve) => {
          resolve(
            `https://hlstats.panda-community.com/hlstats.php?mode=players&game=tf4`
          );
        });
      }
    } else {
