...
private linksHlstats(args: any): Promise<string> {
        if(args.includes(`STEAM_`)) {
            ...
            return new Promise((resolve) => { resolve(`https://hlstats.panda-community.com/hlstats.php?mode=search&q=${steamID}&st=uniqueid&game=`); })
        } else {
